...
switch atlas
    ...
    case 'rat'
        ...
        if exist(fullfile(waxholm_atlas_path,'trajectory_explorer_labels.tsv'),"file")
            st = readtable(fullfile(waxholm_atlas_path,'trajectory_explorer_labels.tsv'),...
...
trajectory_top = [0,0,gui_data.dv_lims(1)];
trajectory_bottom = [0,0,gui_data.dv_lims(2)];
...
for curr_probe = 1:n_probes
    ...
    % Need to remove 0 idx 
    probe_areas_plot(any(probe_areas_plot == 0,2),:) = [];
